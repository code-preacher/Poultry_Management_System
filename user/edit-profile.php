...
$email=$_POST['uemail'];
$ud=date("d/m/y \@ g:i A");
$sql=mysqli_query($con,"Update users set fullname='$fname',address='$address',city='$city',gender='$gender',number='$no',email='$email',updationDate='$ud' where id='".$_SESSION['id']."'");
if($sql)
{
...
<div class="form-group">
					...
					<input type="text" name="no" class="form-control"   value="<?php echo htmlentities($data['number']);?>">
