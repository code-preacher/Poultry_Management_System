				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | products Order History</h1>
																	</div>
								<ol class="breadcrumb">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<div class="table-responsive">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from orderhistory order by id desc");
if (mysqli_num_rows($sql) > 0) {
$cnt=0;
while($row=mysqli_fetch_array($sql))
{
	$t=mysqli_query($con,"select * from users where id='".$row['userid']."'");
	$tk=mysqli_fetch_assoc($t);
	$cnt++;
?>

											<tr>
												<td class="center"><?php echo $cnt;?>.</td>
												<td class="center"><?php echo $tk['fullname'];?></td>
												<td class="center"><?php echo $tk['email'];?></td>
...
<tr>
	<td colspan="5">No product order history at the moment</td>
</tr>
<?php
}
?>
