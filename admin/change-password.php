...
$sql=mysqli_query($con,"SELECT password FROM  admin where password='$cpass' && email='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update admin set password='$npass', updationDate='$currentTime' where email='".$_SESSION['login']."'");
$_SESSION['msg1']="Password Changed Successfully !!";
}
else
{
$_SESSION['msg2']="Old Password not match !!";
}
}
?>
<!DOCTYPE html>
					...
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<p style="color:red;"><?php echo htmlentities($_SESSION['msg2']);?>
								<?php echo htmlentities($_SESSION['msg2']="");?></p>
													<form action="#" role="form" name="chngpwd" method="post" onSubmit="return valid();">
