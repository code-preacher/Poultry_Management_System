...
$p=$_POST['pr'];
$d=$_POST['dt'];
$sql=mysqli_query($con,"update product set name='$n',price='$p',description='$d' where id='$id'");
if($sql)
{
$_SESSION['msg']="product was updated Successfully";
}
}
?>
<!DOCTYPE html>
...
<div class="form-group">
	...
	<input type="text" name="nm" class="form-control"  value="<?php echo htmlentities($row['name']);?>" required />
														</div>
	...
	<input type="text" name="dt" class="form-control" value="<?php echo htmlentities($row['description']);?>" required />
														</div>
...
<div class="form-group">
	...
	<input type="number" name="pr" class="form-control" pattern="[0-9]+" value="<?php echo htmlentities($row['price']);?>" required />
														</div>
